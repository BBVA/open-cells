...
export declare function enqueueCommand(command: string, parameters: any[]): void;
export declare function subscribe(channelName: string, node: object, callback: Function): void;
export declare function unsubscribe(channels: string[] | string, node: object): void;
export declare function publish(channelName: string, value: any, options?: object): void;
export declare function publishOn(channelName: string, htmlElement: HTMLElement, eventName: string): void;
export declare function navigate(page: string, params?: object): void;
